      ...
      <div className="about-page">
        ...
        <div className="about-info">
          ...
          <div className="about-image-mobile">
            <ul className="about-social-medias">
              <li className="social-btn"><i className="fab fa-facebook-square"/></li>
              <li className="social-btn"><i className="fab fa-instagram"/></li>
              <li className="social-btn"><i className="fab fa-weixin"/></li>
            </ul>
          </div>
          <Fade bottom>
            <div className="about-textbox">
              ...
              движение кистью, и в этом плане Катарина – исключительный художник.
              </p>
              <div className="textbox-image-2"/>
              <p>За все время 
